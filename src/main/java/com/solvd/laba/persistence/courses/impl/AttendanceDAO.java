...
public class AttendanceDAO implements IAttendanceDAO{
    ...
    public static Attendance mapRow(ResultSet resultSet, List<Attendance> attendances) throws SQLException {
        Long id = resultSet.getLong("attendance_id");
        ...
        if (id != 0) {
            Attendance attendance = findById(id, attendances);
            attendance.setStatus(resultSet.getString("attendance_status"));
        }
    ...
    private static Attendance findById(Long id, List<Attendance> attendances) {
